...
configurable_parameters = [{'name': 'camera_name',                  'default': 'rs2', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'robot', 'description': 'namespace for camera'},
                           ...
                           {'name': 'rgb_camera.exposure',          'default': '20', 'description': 'control the exposure of the rgb camera'},
