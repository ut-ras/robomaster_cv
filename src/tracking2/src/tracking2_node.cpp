...
private:
    ...
    geometry_msgs::msg::Point32 toPoint32(const Point2f point) const {
    ...
    void callback(const Detection2DArray::ConstSharedPtr msg, const CompressedImage::ConstSharedPtr image_msg) {
        ...
        for (auto& t : tracks_) {
            ...
            predictions.push_back(Point2f(val.at<float>(0), val.at<float>(1)));
        }
        ...
        for (auto& t : tracks_) {
            ...
            Point2f pt(m.at<float>(0), m.at<float>(1));
