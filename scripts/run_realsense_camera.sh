ros2 launch realsense2_camera rs_launch.py rgb_camera.profile:=1280x720x30 depth_module.profile:=1280x720x30 enable_color:=true enable_depth:=true enable_sync:=true camera_namespace:=robot camera_name:=rs2 rgb_camera.enable_auto_exposure:=false rgb_camera.exposure:=10
