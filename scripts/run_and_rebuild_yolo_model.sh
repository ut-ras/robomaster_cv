#!/bin/bash
if [ -e /workspaces/isaac_ros-dev/models/12_1_23-87_8.plan ]
then
    echo "The file /workspaces/isaac_ros-dev/models/12_1_23-87_8.plan still exists. Please move or remove this file before building a new engine file."
    exit
fi
